...
from .views.section_views import SectionListCreateView, SectionRUDView, StudentSectionList, AddStudentToSectionView
...
urlpatterns = [
    ...
    path("students/<section_id>/", AddStudentToSectionView.as_view(), name="add_student_to_section"),
]
